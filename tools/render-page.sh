...
function render_news(    title, desc, community, moonbase, community_desc, moonbase_desc) {
  ...
  print "        <a class=\"button primary\" href=\"archive.html#news-archive\">View archived news →</a>"
  print "      </div>"
  print "    </div>"
  print "  </section>"
  ...
  print "      <div class=\"hero-actions archive-section-actions\">"
  print "        <a class=\"button primary\" href=\"archive.html#commit-archive\">View archived commits →</a>"
  print "      </div>"
  print "    </div>"
  print "  </section>"
  print "</main>"
